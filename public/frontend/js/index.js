...
var statuses = {      
    0: ['Đơn hàng hủy', 'bg-red fg-white'],
    1: ['Chuẩn bị hàng', 'bg-yellow'],
    2: ['Đợi vận chuyển', 'bg-lightGreen fg-white'],
    3: ['Đã giao hàng', 'bg-teal fg-white'],
    4: ['Đã thanh toán', 'bg-green fg-white'],
};
